...
const RecipePlaceholder = () => (
  <div className='relative m-auto flex h-fit w-full max-w-4xl flex-grow-0 animate-pulse flex-col justify-between overflow-hidden rounded-3xl border-2 border-gray-300 sm:w-2/3 md:h-128 md:w-full md:flex-row'>
