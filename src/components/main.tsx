...
const Main = () => {
  return (
    <section className='m-auto w-full px-4 py-10 text-left lg:p-20 xl:w-3/4'>
      <SignedIn>
        <div>
          Check if any plants are selected. link to plant page. if selected,
          fetch recipes
        </div>
      </SignedIn>
      <SignedOut>
            ...
            <div className='flex flex-col gap-4 md:justify-between '>
              ...
              <div className=' flex flex-col items-center gap-3 rounded-lg border-2 border-gray-200 p-6 shadow-lg xs:flex-row'>
                ...
                <div>
                  ...
                  garden's bounty. No more waste, just culinary creativity! Save
                  your favorites to find them later.
                </div>
              </div>
              <div className='flex flex-col items-center gap-3 rounded-lg border-2 border-gray-200 p-6 shadow-lg xs:flex-row'>
                <div className='m-auto flex w-20 shrink-0'>
                ...
                <div>
                  ...
                  We&nbsp;evolve with the seasons, serving up fresh recipes as
